  ...
  return (
    <>
      <div className="border-t border-line">
        <div className="group flex items-center text-[14px] text-sub hover:bg-soft/60 hover:text-ink">
          <button
          ...
          <button
            ...
            title="新建上下文"
            aria-label="新建上下文"
            className="mr-2 rounded-md p-1.5 text-hint/70 transition hover:bg-paper hover:text-moss"
          >
        ...
        {expanded && (
          <ul className="max-h-[40vh] space-y-1 overflow-y-auto pb-2.5 pl-8 pr-1">
            {contexts.length === 0 ? (
              <li>
                <button
              ...
              contexts.map((c) => (
                <li key={c.id}>
                  <div className="group/row flex items-center gap-2 rounded-md px-2.5 py-1.5 text-[13.5px] text-sub transition-colors hover:bg-soft/60 hover:text-ink">
                    <button
                    ...
                    <div className="flex shrink-0 items-center gap-0.5 opacity-0 transition group-hover/row:opacity-100">
                      <button
                        ...
                        title="编辑"
                        aria-label="编辑上下文"
                        className="rounded-md p-1.5 text-hint/70 hover:bg-paper hover:text-moss"
                      >
                      ...
                      <button
                        ...
                        title="删除"
                        aria-label="删除上下文"
                        className="rounded-md p-1.5 text-hint/70 hover:bg-paper hover:text-amber"
                      >
